...
async function createCard(type, paper) {
  if(type){
    ...
    paperSection.setAttribute("class", "paper-card");
      ...
      abstractDiv.setAttribute("id", `abstractDiv${count + 1}`);
        ...
        abstractBtn.setAttribute("onclick", `abstractCollapse(${count + 1})`)
      ...
      reviewBtn.setAttribute("onclick", `openModal(${count + 1})`);
      ...
      modalDiv.setAttribute("style", `display: none;`);
        ...
        modalContentDiv.setAttribute("class", "modal-content");
          ...
          modalSpan.setAttribute("onclick", `closeModal(${count + 1})`);
          modalSpan.innerHTML = "×"
...
// TODO: Create a function to handle openModal(id)
function openModal(id) {
  const modal = document.getElementById(`modal${id}`);
  modal.style.display = "block";
}
// TODO: Create a function to handle closeModal(id)
